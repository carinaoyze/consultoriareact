...
import fotoSobre from '../../assets/images/foto-concessionaria.jpg';
...
export default function SobrePage() {
    return (
        <MasterLayout>
            <Helmet>
                <title>MeuCarango | Sobre a empresa</title>
            </Helmet>
            <main className="container">
                <h1 className="cabecalho-pagina">Sobre a empresa</h1>
                <figure className="foto-concessionaria">
                    <img src={ fotoSobre } alt="Foto do pátio da concessionária" />
                    <figcaption>
